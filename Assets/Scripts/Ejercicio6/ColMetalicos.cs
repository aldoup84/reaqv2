...
public class ColMetalicos : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Enlace c = FBManager.getInstance().GetInformacion(comp);
        ...
        else
        {
            ...
            mostrar = false;
            txtMsg.text = "Marcadores erroneos.... \n";
