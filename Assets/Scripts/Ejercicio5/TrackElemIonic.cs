...
/// </summary>
public class TrackElemIonic : MonoBehaviour {
    TextMeshProUGUI txtElem, txtInst, txtTarget;
    ...
    protected virtual void Start()
    {
        ...
        txtInst = GameObject.Find("txtInstrucciones").GetComponent<TextMeshProUGUI>();
        txtTarget = GameObject.Find("txtTarget").GetComponent<TextMeshProUGUI>();
    }
