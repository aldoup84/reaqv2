...
public class TrackElemEj2 : MonoBehaviour
{
    Text txtTarget;
    TextMeshProUGUI txtElem2, txtAyuda, txtNumElem, txtPesoA, txtSimbolo, txtConcepto, txtConsultas;
    ...
    protected virtual void Start()
    {
        ...
        txtElem2 = GameObject.Find("txtElem2A").GetComponent<TextMeshProUGUI>();
    }
